...
// LAY THONG TIN API
const request = async function (cat, page, pageNum) {
  const res = await fetch(
    `https://newsapi.org/v2/top-headlines?country=us&category=${cat}&pageSize=${page}&page=${pageNum}&apiKey=bc2565cf28ce439ca5f3a779c11e6c69`
  );
...
if (userLogin === "") {
  ...
  request(curUser.cat, curUser.page, curPage);
}
